...
<article>
          ...
          <!-- <br> -->
<h2 class="w3-container w3-animate-top w3-panel w3-green w3-topbar w3-bottombar w3-border-light-green w3-hover-light-grey" ><b>Kurikulum</b></h2>
              <!-- <h2 class="w3-container w3-animate-top" ><b>Struktur Kurikulum Nasional</b></h2> -->
              <p style="border: 0px; background-color: #f8f8f8;;"><font style="font-family: rockwell;font-size: 24px;" >
                <div class="w3-container">
<button onclick="myFunction('Demo1')" class="w3-btn w3-block w3-purple w3-left-align" style="border-radius: 10px;">Struktur Kurikulum Nasional</button>
<div id="Demo1" class="w3-container w3-hide">
<p style="background-color: white;margin-top: 10px;padding-left: 10px;" >1.  Pendidikan Agama Islam<br>
2.  Pendidikan Kewarganegaraan<br>
3.  Bahasa Indonesia<br>
4.  Matematika<br>
5.  Ilmu Pengetahuan Alam<br>
6.  Ilmu Pengetahuan Sosial<br>
7.  Seni Budaya dan Keterampilan<br>
8.  Pendidikan Jasmani, Olahraga dan Kesehatan.</p>
</div><br><br>
<button onclick="myFunction('Demo2')" class="w3-btn w3-block w3-yellow w3-left-align" style=" margin-top:-60px;border-radius:10px;">Struktur Kurikulum Muatan Lokal</button>
<div id="Demo2" class="w3-container w3-hide">
<p style="background-color: white;margin-top: 10px;padding-left: 10px;" >1.  Bahasa Sunda<br>
2.  Pendidikan Lingkungan Hidup<br>
3.  Bahasa Inggris<br>
4.  Keterampilan/Teknologi Informasi dan Komunikasi.</p>
</div><br><br>
<button onclick="myFunction('Demo3')" class="w3-btn w3-block w3-blue w3-left-align" style=" margin-top:-60px;border-radius:10px;">Struktur Kurikulum Unggulan</button>
<div id="Demo3" class="w3-container w3-hide">
<p style="background-color: white;margin-top: 10px;padding-left: 10px;" >1.  Tahsin Al-Qur’an Metode Ummi<br>
2.  Tahfizh Al-Qur’an Juz 30<br>
3.  Do’a Harian<br>
4.  Bahasa Arab<br>
5.  Pendidikan Karakter Islam.</p>
</div>
<br><br>
<button onclick="myFunction('Demo4')" class="w3-btn w3-block w3-red w3-left-align" style=" margin-top:-60px;border-radius:10px;">Program Pengembangan Diri</button>
<div id="Demo4" class="w3-container w3-hide">
<p style="background-color: white;margin-top: 10px;padding-left: 10px;" >1.  Shalat Berjama’ah<br>
2.  Shalat Dhuha<br>
3.  Perayaan Hari Besar Islam<br>
4.  Pesantren Ramadhan<br>
5.  Pekan Kreatifitas Siswa<br>
6.  Field Trip<br>
7.  Mabit (Malam Bina Iman dan Taqwa)<br>
8.  Mukhayam.</font></p>
</div>
</div>
        </p>

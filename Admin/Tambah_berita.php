      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-body">
            <?php 
            include ('../Config.php');
            $tampil = mysqli_query($koneksi,"select max(id_berita)as id_berita from berita");
              ...
              <?php
                if (isset($_POST['kirim'])){
                  ...
                  move_uploaded_file($temp, $folder . $name);
                    // insert data ke database
                  $insert = "insert into berita values ('$id', '$hari', '$waktu', '$judul', '$isi', '$name')";
            ...
            <form action="" method="post" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                ...
                <input class="form-control "
                 type="text" name="judul" min="0" placeholder="Judul Berita" required="required" />
              </div>
              ...
              <div class="form-group">
                ...
                <input class="form-control"
                 type="file" name="cover" min="0" required="required" />
              </div>

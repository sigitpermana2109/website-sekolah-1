      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-danger">
            ...
            <a href="menampilkan_fotoeskul.php"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
          <div class="box-body">
          <?php
            $a = $_GET['id'];
            include ('../Config.php');
            $tampil = mysqli_query($koneksi,"select * from eskul where id_eskul = $a");
            ...
            if (isset($_POST['kirim'])){
              ...
              $keterangan = $_POST['ket'];
               // insert data ke database
                $edit = "update eskul set keterangan='$keterangan' where id_eskul='$id'";

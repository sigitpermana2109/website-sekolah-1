      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-body">
            ...
            include ('../Config.php');
            $id = $_GET['id'];
            $tampil = mysqli_query($koneksi,"select * from guru where id_guru=$id");
            while ($baris = mysqli_fetch_array($tampil)){?>
                ...
                if (isset($_POST['kirim'])){
                  ...
                  while ($baris4 = mysqli_fetch_array($tampil)){
                  ...
                  $edit = "update guru set nuptk='$nuptk', nama='$nama', jk='$jk', tempat_lahir='$tempat', tanggal_lahir='$tanggal', id_status='$id_status', id_ptk='$id_ptk', id_jenjang='$id_jenjang', id_kompetensi='$id_kompetensi', foto='$name' where id_guru='$id'";
            ...
            <form action="" method="post" enctype="multipart/form-data" >
              <div class="form-group">
                <input type="hidden" name="id_guru" value="<?php echo $baris['id_guru'] ?>">
                ...
                <input class="form-control "
                 type="text" name="nuptk" min="0" value="<?php echo $baris['nuptk'];?>" required="required"/>
              </div>
              ...
              <div class="form-group">
                ...
                <input class="form-control "
                 type="text" name="nama" min="0" value="<?php echo $baris['nama'];?>" required="required" />
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  <label>
                    <input type="radio" name="jk" class="flat-red" value="Laki-laki" checked="<?php echo $baris['jk'];?>">
                    Laki - laki &nbsp&nbsp
                  </label>
                  <label>
                    <input type="radio" name="jk" class="flat-red" value="Perempuan" checked="<?php echo $baris['jk'];?>">
                    Perempuan
                  </label>
                </div>
                <!-- /.input group -->
              ...
              <div class="form-group">
                ...
                <input class="form-control "
                 type="text" name="tempat" min="0" value="<?php echo $baris['tempat_lahir'];?>" required="required" />
              </div>
              ...
              <div class="form-group">
                ...
                <input class="form-control "
                 type="date" name="tanggal" min="0" required="required" value="<?php echo $baris['tanggal_lahir'];?>" />
              </div>
              ...
              <div class="form-group">
                ...
                <input class="form-control"
                 type="file" name="cover" min="0" placeholder="guru yang Diraih" value="<?php echo $baris['foto'];}?>" required="required" />
              </div>

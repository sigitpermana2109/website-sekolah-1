...
<html lang="en">
  <head>
    ...
    <!-- Main style sheet -->
    <link rel="stylesheet" type="text/css" href="css/galeri2.css">
   <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<ul class="nav navbar-nav navbar-right menu-2" >
  ...
  <li class="menu-item-17 active"><a title="Galeri" href="foto_eskul.php" style="color: white;"><span class="fa fa-camera"></span> Galeri</a>
  </li>
...
<br>
 ...
 <section id="mu-gallery">
          ...
          <div class="mu-gallery-content">
            ...
            <div class="mu-gallery-top">              
              <ul>
                ...
                <li class="filter" data-filter=".lab">Ekstrakulikuler</li>
                <li class="filter" data-filter=".classroom">Kegiatan Sekolah</li>
                <li class="filter" data-filter=".library">Kegiatan Guru</li>
              </ul>
            </div>
            <!-- End gallery menu -->
            <div class="mu-gallery-body">
              <ul id="mixit-container" class="row">
                ...
                <?php
          include 'Config.php';
  $a =mysqli_query($koneksi, "select * from eskul ");
    while ($baris = mysqli_fetch_array($a)){
    $id = $baris['id_eskul'];
    $id2 = $baris['id_galeri'];
  $tampil = mysqli_query($koneksi,"select * from galeri where id_galeri='$id2' && jenis_kegiatan='Eskul'");
  while ($baris2 = mysqli_fetch_array($tampil)){
    $gambar = $baris2['gambar'];
    echo "
                <li class='col-md-4 col-sm-6 col-xs-12 mix lab'>
                  <div class='mu-single-gallery'>                  
                    <div class='mu-single-gallery-item'>
                      <div class='mu-single-gallery-img'>
                        <a href=''><img alt='img' src='galeri/".$gambar."'></a>
                      </div>
                      <div class='mu-single-gallery-info'>
                        <div class='mu-single-gallery-info-inner'>
                          <h4>Galeri</h4>
                          <p>$baris[keterangan]</p>
                          <a href='galeri/".$gambar."' data-fancybox-group='gallery' class='fancybox' title='Detail'><span class='fa fa-eye'></span></a>
                        </div>
                      </div>                  
                    </div>
                  </div>
                 ...
                 <?php
                  include 'Config.php';
  $a =mysqli_query($koneksi, "select * from keg_guru ");
    while ($baris = mysqli_fetch_array($a)){
    $id2 = $baris['id_galeri'];
  $tampil = mysqli_query($koneksi,"select * from galeri where id_galeri='$id2' && jenis_kegiatan='Guru'");
  while ($baris2 = mysqli_fetch_array($tampil)){
    $gambar = $baris2['gambar'];
    echo "
  ...
  $a =mysqli_query($koneksi, "select * from keg_sekolah ");
    while ($baris = mysqli_fetch_array($a)){
    $id2 = $baris['id_galeri'];
  $tampil = mysqli_query($koneksi,"select * from galeri where id_galeri='$id2' && jenis_kegiatan='Sekolah'");
  while ($baris2 = mysqli_fetch_array($tampil)){
    $gambar = $baris2['gambar'];
    echo "

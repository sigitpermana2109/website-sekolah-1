...
<article>
            <div class="info">
             <h2 class="w3-container w3-animate-top w3-panel w3-green w3-topbar w3-bottombar w3-border-light-green  w3-hover-light-grey" style="margin-right: 10%;margin-left: 10%;"><b>TUJUAN</b></h2>
    ...
    Tujuan pendidikan adalah meletakkan dasar kecerdasan, pengetahuan, kepribadian akhlak mulia 
serta keterampilan untuk hidup mandiri dan mampu mengikuti pendidikan lebih lanjut. Tujuan 
SDIT Citra Winaya adalah :<br>
1.  Memiliki Keimanan yang Kokoh dan Akhlak Mulia sebagai Bekal Hidup.<br>
2.  Mampu Membaca, Menghafal dan Mengamalkan Al-Qur'an dalam Kehidupan Sehari-hari.<br>
3.  Memiliki Dasar-dasar Ilmu Pengetahuan dan Teknologi sebagai Bekal untuk Melanjutkan 
     ke Jenjang Pendidikan yang Lebih Tinggi.<br>
4.  Mampu Meraih Prestasi Akademik Maupun Non Akademik.</font>
              </pre>
            </div>
          </article>   
                  </div>

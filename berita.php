...
<ul class="nav navbar-nav navbar-right menu-2" >
  ...
  <li class="menu-item-456"><a title="Kontak" href="#footer" class="get-contact" style="color: white;"><span class="fa fa-phone fa-lg"></span> Kontak</a>
        ...
        <form class="navbar-form hidden-md hidden-lg" role="search">
...
?>
<div class="info">
<p class="a" style="margin-top: 5px; font-size: 25px;margin-left: 10%;margin-right: 10%;"><b><?php echo $baris['judul'];?></b></p>
<h4 class="a" style="margin-top: 5px; font-size: 12px;margin-left: 10%;margin-right: 10%;"><?php echo "Tanggal : ".date('d M Y', strtotime($baris['hari']))." | Pukul : ". date('H:m:s', strtotime($baris['hari']))." | <a href='index.php' style='color: green;'>Home</a>";?></h4>
<div style="margin-left: 10%;margin-right: 10%;" class="w3-panel w3-pale-green w3-leftbar w3-border-green w3-container w3-animate-top">
  <font style="font-size: 17px; text-align: left;" >
  <img src="berita/<?php echo $baris['gambar'];?>" style="float:left;display:block;margin-left:auto;margin-right:20px;width: 40%;margin-bottom: 10px; margin-top: 10px;">

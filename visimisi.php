...
<body style="background-color: white;">
  ...
  <nav class="navbar navbar-default navbar-fixed-top" style=" background-color: green;margin-right: ">
...
<!-- <article> -->
            ...
            <div class="col-md-6">
            <div class="info">
              <h2 class="w3-container w3-animate-top w3-panel w3-green w3-topbar w3-bottombar w3-border-light-green w3-hover-light-grey" ><b>VISI</b></h2>
              <p  class="w3-panel w3-pale-green w3-leftbar w3-border-green w3-container w3-animate-top w3-center w3-hover-light-grey"><font style="font-family: rockwell;font-size: 18px;" >
<b>&#10077; Menjadi sekolah dasar islam unggulan berlandaskan Al-Qur'an dan Hadist
sehingga terwujud generasi Qurani yang cerdas dan berakhlak mulia.  &#10078;</b></font>
              </p>
            </div>
          </div>
          <!-- </article> -->
          ...
          <article>
            <div class="col-md-6">
            <div class="info">
              <h2 class="w3-container w3-animate-top w3-panel w3-green w3-topbar w3-bottombar w3-border-light-green w3-hover-light-grey" ><b>MISI</b></h2>
              <p class="w3-panel w3-pale-green w3-leftbar w3-border-green w3-container w3-animate-top w3-hover-light-grey" style="border:1px;"><font style="font-family: rockwell;font-size: 18px;" >
1.  Melaksanakan Pembelajaran Al-Qur'an Sebagai Sumber Utama Pendidikan.<br>
2.  Mengenmbangkan Kultur Pendidikan Islam.<br>
3.  Menyiapkan SDM yang Berkualitas dan Berkepribadian Islam.<br>
4.  Menyelenggarakan Pendidikan Siswa yang Aktif, Produktif dan Sholeh dalam Dirinya.<br>
5.  Melaksanakan Pengelolaan Sekolah yang Amanah, Berkualitas, Efektif dan Efisien.</font>
              </p>
            </div>
          </div>
          </article>
